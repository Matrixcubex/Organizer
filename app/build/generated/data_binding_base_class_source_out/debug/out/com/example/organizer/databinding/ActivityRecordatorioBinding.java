...
public final class ActivityRecordatorioBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityRecordatorioBinding(@NonNull LinearLayout rootView, @NonNull Button btnBack,
  ...
  @NonNull
  public static ActivityRecordatorioBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRecordatorioBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_recordatorio, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRecordatorioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRecordatorioBinding((LinearLayout) rootView, btnBack, btnGuardar,
          etDescripcion, etHora, etNombre, progressBar);
    }
