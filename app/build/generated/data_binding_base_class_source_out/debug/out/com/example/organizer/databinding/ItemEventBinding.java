...
public final class ItemEventBinding implements ViewBinding {
  ...
  private ItemEventBinding(@NonNull CardView rootView, @NonNull TextView eventContact,
  ...
  public static ItemEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEventBinding((CardView) rootView, eventContact, eventDate, eventDescription,
          eventStatus, eventTime, eventTitle, eventType);
    }
