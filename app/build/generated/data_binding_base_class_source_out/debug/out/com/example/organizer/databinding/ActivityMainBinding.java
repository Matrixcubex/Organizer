...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton btnActivities;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageButton btnActivate = ViewBindings.findChildViewById(rootView, id);
      if (btnActivate == null) {
        break missingId;
      }

      id = R.id.btn_activities;
      ImageButton btnActivities = ViewBindings.findChildViewById(rootView, id);
